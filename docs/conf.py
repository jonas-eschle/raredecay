...
# sphinx-quickstart on Mon Oct  3 10:37:36 2016.
#
...
project = u'raredecay'
copyright = u'2016, Jonas Eschle'
author = u'Jonas Eschle'
...
latex_documents = [
    (master_doc, 'raredecay.tex', u'raredecay Documentation',
     u'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'raredecay', u'raredecay Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'raredecay', u'raredecay Documentation',
     author, 'raredecay', 'One line description of project.',
     'Miscellaneous'),
]
...
.. |plot_importance_type| replace:: |importance_type|
.. |plot_importance_docstring| replace::        The higher the importance, the more likely the plots will be shown. All plots will be saved anyway if an output path was initialized.
.. |take_target_from_data_docstring| replace::         OUTDATED; not encouraged to use
