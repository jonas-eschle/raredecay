...
class TestReweight_kfold(unittest.TestCase):
    def setUp(self):
        self.true_gb_weights = pd.Series(
                [-0.8445911463880363, 0.10392354693854089, 4.879479245649117, 1.0640894095667925,
                 0.9544838901519904, 4.355682683575129, -4.005817560682537, 3.1763768734231475,
                 -2.127926792187807, 2.283638075651694, 0.9822853141337221, -0.13729257526778438,
                 2.8164731292156384, -1.5258383628154988, 2.1366382819086316, -0.613947023233219,
                 1.1524348388850445, 2.878090879070167, -0.32933349305753845, -2.5309720492380885,
                 5.516566780275948, 3.2140143794584555, -0.16303269607011947, 2.322287555717381,
                 2.5113999253510118, -1.237371251299992, 5.545778201177078, -1.2877793322848847,
                 -2.547687088118431, 1.3908237012492812, 1.9959032812505426, 2.1196318339547453,
                 -3.9638059566600994, -2.310918705082194, -2.613449599328348, 0.8082753723579998,
                 -2.287562413169768, 3.7296340418359373, 3.645462008395379, 0.7456757318529652,
                 0.0848644563458703, -0.14574648154477018, 0.313946264807159, 2.6556493859751833,
                 4.480049388431625, 4.602528251174691, 2.7697024937462116, 0.6308628907656573,
                 5.377065018674339, -2.570644604537956]
                )
...
class TestReweightOld(unittest.TestCase):
    def setUp(self):
        self.true_gb_weights = pd.Series(
                [-25.545385335151842, 24.809757564148676, -6.210336870882619, -40.42883925946502,
                 -37.21340108829993, 94.58667184700776, 21.708829790052395, -83.31284025316096,
                 26.959001638897725, -9.528695221312033, 0.2252060216376917, 40.130461660011925,
                 57.9145490749728, -42.035674114297095, -1.4557428424736885, -26.730093063397767,
                 29.21417361329943, -11.370436972473696, 1.4317506344905568, -13.229037573765734,
                 -5.194153776038895, 83.43629738382411, 117.01907076876122, 18.45724900004109,
                 -4.893147189184952, -78.10045741630597, -37.21962961033722, -6.203255407884731,
                 -34.999672846733176, -29.852363474185665, 77.10942837893583, 1.4092027568413132,
                 5.786035285020609, -32.99910884405319, 57.636414431430275, -10.404929548991348,
                 -25.494330224087857, -77.37184609875148, -2.990710373413925, -27.02117644563831,
                 82.45388420658254, 90.25195132405007, -60.46236464550644, -54.92520811618094,
                 -13.52481368281434, -39.94200588848087, 10.64172901202869, -15.986999375891335,
                 13.731009872959032, 49.73398129416737]
...
class TestReweightNew(unittest.TestCase):
    def setUp(self):
        self.true_gb_weights = pd.Series([2.36993392272, 3.71455903608, 7.17398143621, 6.980238845,
                                          ...
                                          3.40324698139, 3.41160454189, 25.5199598051,
                                          3.78149967661,
                                          ...
                                          4.1989918084, -13.4142640193, 1.2350475578,
                                          -4.38358188765,
